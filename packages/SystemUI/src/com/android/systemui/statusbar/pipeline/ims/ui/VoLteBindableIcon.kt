...
import com.android.systemui.statusbar.pipeline.ims.ui.viewmodel.VoLteStatusBarIconViewModel
import com.android.systemui.statusbar.pipeline.shared.ui.view.SingleBindableStatusBarIconView
import javax.inject.Inject

@SysUISingleton
class VoLteBindableIcon
@Inject
constructor(
    context: Context,
    viewModel: VoLteStatusBarIconViewModel,
) : BindableIcon {
    override val slot: String =
        context.getString(com.android.internal.R.string.status_bar_volte)
