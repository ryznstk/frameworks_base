...
import com.android.systemui.statusbar.pipeline.ims.ui.viewmodel.VoWifiStatusBarIconViewModel
import com.android.systemui.statusbar.pipeline.shared.ui.view.SingleBindableStatusBarIconView
import javax.inject.Inject

@SysUISingleton
class VoWifiBindableIcon
@Inject
constructor(
    context: Context,
    viewModel: VoWifiStatusBarIconViewModel,
) : BindableIcon {
    override val slot: String =
        context.getString(com.android.internal.R.string.status_bar_vowifi)
    ...
    override val initializer = ModernStatusBarViewCreator { context ->
        SingleBindableStatusBarIconView.createView(context).also { view ->
            view.requireViewById<ImageView>(R.id.icon_view).apply {
                ...
                // Keep IMS icons width-tight while preserving the standard status bar icon height.
